...
// 颜色方案
const colors = {
	'人类': 'rgba(30, 64, 175, 0.8)',         // 深蓝
	'Doubao-v1': 'rgba(59, 130, 246, 0.5)',   // 浅蓝
	'GLM-4V': 'rgba(156, 163, 175, 0.7)',     // 灰色
	'Qwen-VL-Max': 'rgba(153, 27, 27, 0.7)',  // 红色
	'Qwen-VL-Plus': 'rgba(153, 27, 27, 0.7)'  // 红色
};

const borderColors = {
	'人类': 'rgba(30, 64, 175, 1)',         // 深蓝
	'Doubao-v1': 'rgba(59, 130, 246, 1)',   // 浅蓝
	'GLM-4V': 'rgba(156, 163, 175, 1)',     // 灰色
	'Qwen-VL-Max': 'rgba(255, 0, 0, 0.7)',  // 红色
	'Qwen-VL-Plus': 'rgba(255, 0, 0, 0.7)'  // 红色
};
...
const radarDatasets = [{
	...
	backgroundColor: colors['人类'].replace('0.8', '0.2'),
...
},
{
	...
	backgroundColor: colors['Doubao-v1'].replace('0.8', '0.2'),
...
},
{
	...
	backgroundColor: colors['Qwen-VL-Max'].replace('0.8', '0.2'),
...
},
{
	...
	backgroundColor: colors['GLM-4V'].replace('0.8', '0.2'),
